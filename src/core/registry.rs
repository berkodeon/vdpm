...
mod registry_integration_tests {
    use crate::core::plugin::Plugin;
    use crate::{
        config_loader::{self, RuntimeSettings},
    ...
    fn bootstrap() -> MockFileDirs {
        config_loader::init(RuntimeSettings {
    ...
    async fn test_should_persist_added_plugin_into_registry_file() {
        ...
        assert!(plugins_csv_content.contains("foo,false,true\n"));
        assert!(plugins_csv_content.contains("bar,true,true\n"));
        assert!(plugins_csv_content.contains("baz,true,true\n"));
    }
    ...
    async fn test_should_persist_updated_plugin_into_registry_file() {
        ...
        assert!(plugins_csv_content.contains("foo,true,true\n"));
        assert!(plugins_csv_content.contains("bar,true,true\n"));
    }
    ...
    async fn test_should_persist_deleted_plugin_into_registry_file() {
        ...
        assert!(!plugins_csv_content.contains("bar"));
        assert!(!plugins_csv_content.contains("bar,true,true\n"));
        assert!(plugins_csv_content.contains("foo,false,true\n"));
    }
}
